...
def eta_animation(X, Y, eta_list, frame_interval, filename = "eta_animation"):
...
def velocity_animation(X, Y, u_list, v_list, frame_interval, filename = "velocity_animation"):
...
def eta_animation3D(X, Y, eta_list, frame_interval, filename = "eta_animation_3D"):
